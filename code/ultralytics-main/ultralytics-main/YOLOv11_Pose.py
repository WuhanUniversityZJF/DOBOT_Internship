...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='/home/sunrise/Desktop/yolo11n_pose_bayese_640x640_nv12_modified.bin', 
                        help="""Path to BPU Quantized *.bin Model.
                                ...
                                RDK S100: Nash-e.
                                RDK S100P: Nash-m.""") 
    parser.add_argument('--test-img', type=str, default='/home/sunrise/Desktop/img_pose.jpg', help='Path to Load Test Image.')
    parser.add_argument('--img-save-path', type=str, default='/home/sunrise/Desktop/img_pose_result.jpg', help='Path to Load Test Image.')
